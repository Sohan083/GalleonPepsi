package com.example.galleonpepsi.model
...
class User {
    ...
    var employeeTypeId: String? = null
    ...
    fun setValuesFromSharedPreference(sharedPreference: SharedPreferences) {
        ...
        employeeTypeId = sharedPreference.getString("employeeTypeId", null)
    ...
    fun setEmployeeTypeId(editor: SharedPreferences.Editor, id: String?, employeeTypeId: String?) {
        this.employeeTypeId = employeeTypeId
        saveToSharepreference(editor, id, employeeTypeId)
    }
